...
const create = async (req: NextApiRequest, res: NextApiResponse<unknown>) => {
  try {
                    ...
                    <td style="padding: 10px 0px;background-color: #ffffff;font-size: 11px;font-family: 'Montserrat', sans-serif; font-weight: 200; color: #ababab;">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color:#fff;">
                            ...
                            <tr style="border-top: 1px dotted #d3d3d3;color: #000;">
                                ...
                                <td style="text-align: right;font-size: 15px; fontWeight: 600;padding: 10px;" colspan="2">${_body.totalPrice.toFixed(
                                  2
                                )} € </td>
                            </tr>
                        </table>
                    ...
                    <td style="padding: 10px 10px;background-color: #ffffff;">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color:#fff;">
                            <tr>
                                ...
                                ${
                                  _body.bussinesName
                                    ? `${_body.bussinesName}<br>${_body.ico}<br>`
                                    : ''
                                }
    ...
    return transporter.sendMail(mailOptions, (error: any) => {
      ...
      return res.send('Email successfully sended')
    })
  } catch (error) {
