...
export const ICONS: IconData = {
  ...
  [IconType.SELECT_DIMENSION]: {
    data: exampleIconPaths.selectDimension,
    viewBox: "0 0 163.77 63.49",
  },
  [IconType.UPDATE_CROPPER]: {
    data: exampleIconPaths.updateCropper,
    viewBox: "0 0 80.3 63.49",
  },
};
