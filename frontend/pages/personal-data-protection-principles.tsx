...
const PersonalDataProtectionPrinciples: NextPage = () => {
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <Container className={styles.container}>
          <EditableContent
            identifier={EditablePage.PersonalDataProtectionPrinciples}
          />
        </Container>
      </main>
      <footer>
...
export default PersonalDataProtectionPrinciples
