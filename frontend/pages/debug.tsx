    ...
    <div>
      ...
      <main>
        <Grid container direction="column">
          ...
          {variable("NEXT_PUBLIC_SMART_EMAILING_HOST_TEST", process.env.NEXT_PUBLIC_SMART_EMAILING_HOST_TEST)}
          {variable("NEXT_PUBLIC_SMART_EMAILING_TOKEN_TEST", process.env.NEXT_PUBLIC_SMART_EMAILING_TOKEN_TEST)}
          {variable("NEXT_PUBLIC_SMART_EMAILING_CONTACT_LIST_ID_TEST", process.env.NEXT_PUBLIC_SMART_EMAILING_CONTACT_LIST_ID_TEST)}
          {variable("NEXT_PUBLIC_SUPERFAKTURA_EMAIL_TEST", process.env.NEXT_PUBLIC_SUPERFAKTURA_EMAIL_TEST)}
          {variable("NEXT_PUBLIC_SUPERFAKTURA_API_KEY_TEST", process.env.NEXT_PUBLIC_SUPERFAKTURA_API_KEY_TEST)}
          {variable("NEXT_PUBLIC_SUPERFAKTURA_COMPANY_ID_TEST", process.env.NEXT_PUBLIC_SUPERFAKTURA_COMPANY_ID_TEST)}
          {variable("NEXT_PUBLIC_SUPERFAKTURA_MODULE_TEST", process.env.NEXT_PUBLIC_SUPERFAKTURA_MODULE_TEST)}
          {variable("NEXT_PUBLIC_STRIPE_PUBLIC_KEY_TEST", process.env.NEXT_PUBLIC_STRIPE_PUBLIC_KEY_TEST)}
          {variable("NEXT_PUBLIC_STRIPE_SECRET_KEY_TEST", process.env.NEXT_PUBLIC_STRIPE_SECRET_KEY_TEST)}
          {variable("NEXT_PUBLIC_NODE_MAILER_SERVICE_TEST", process.env.NEXT_PUBLIC_NODE_MAILER_SERVICE_TEST)}
          {variable("NEXT_PUBLIC_NODE_MAILER_HOST_TEST", process.env.NEXT_PUBLIC_NODE_MAILER_HOST_TEST)}
          {variable("NEXT_PUBLIC_NODE_MAILER_SECURE_TEST", process.env.NEXT_PUBLIC_NODE_MAILER_SECURE_TEST)}
          {variable("NEXT_PUBLIC_NODE_MAILER_PORT_TEST", process.env.NEXT_PUBLIC_NODE_MAILER_PORT_TEST)}
          {variable("NEXT_PUBLIC_NODE_MAILER_USER_TEST", process.env.NEXT_PUBLIC_NODE_MAILER_USER_TEST)}
          {variable("NEXT_PUBLIC_NODE_MAILER_PASSWORD_TEST", process.env.NEXT_PUBLIC_NODE_MAILER_PASSWORD_TEST)}
        </Grid>
      </main>
